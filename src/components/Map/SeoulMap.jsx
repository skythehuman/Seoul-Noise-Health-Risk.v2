  ...
  return (
    <div>
      ...
      <div className="legend">
        <div className="legend-item"><div className="legend-swatch" style={{ background: RISK_COLORS.Low }} /> Low (EBD &lt; 239 &amp; Elderly &lt; 620)</div>
        <div className="legend-item"><div className="legend-swatch" style={{ background: RISK_COLORS.Medium }} /> Medium (one threshold exceeded)</div>
        <div className="legend-item"><div className="legend-swatch" style={{ background: RISK_COLORS.High }} /> High (both exceeded)</div>
      </div>
    </div>
  );
}
